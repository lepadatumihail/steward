...
- **Constraints** (same resolution): **solo** entry; **25–35h** across the 8 days; **ChatGPT Plus/Pro + desktop app available**, so the ChatGPT desktop browser is the primary demo and shooting target (Chrome 149 + flag is the backup and wallet-extension lane); **Base-mainnet burner ~$5 approved** — the human funds, holds, and signs everything, no assistant session touches keys or funds.
